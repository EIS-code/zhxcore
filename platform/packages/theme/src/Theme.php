...
namespace ZHXCore\Theme;

use ZHXCore\Theme\Contracts\Theme as ThemeContract;
use ZHXCore\Theme\Exceptions\UnknownLayoutFileException;
use ZHXCore\Theme\Exceptions\UnknownPartialFileException;
use ZHXCore\Theme\Exceptions\UnknownThemeException;
...
class Theme implements ThemeContract
{
    ...
    public function render($statusCode = 200)
    {
        ...
        $content->withHeaders([
            'Author'            => 'ZHXSCRIPT LLC (info@zhxscript.com)',
            'Author-Team'       => 'https://zhxscript.com',
            'CMS'               => 'ZHXCore CMS',
            'CMS-Version'       => get_cms_version(),
            //'Authorization-At'  => setting('membership_authorization_at'),
            'License-Activated' => !empty(setting('licensed_to')) ? 'Yes' : 'No',
        ]);
