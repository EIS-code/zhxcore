...
namespace ZHXCore\Translation\Http\Controllers;
...
use ZHXCore\Translation\Http\Requests\LocaleRequest;
use ZHXCore\Translation\Http\Requests\TranslationRequest;
use ZHXCore\Translation\Manager;
use DB;
use File;
use Illuminate\Http\Request;
use ZHXCore\Translation\Models\Translation;
