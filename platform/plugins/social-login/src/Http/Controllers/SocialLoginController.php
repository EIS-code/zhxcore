...
namespace ZHXCore\SocialLogin\Http\Controllers;

use Assets;
use ZHXCore\Member\Repositories\Interfaces\MemberInterface;
...
use ZHXCore\SocialLogin\Http\Requests\SocialLoginRequest;
use Exception;
