...
@section('content')
    <div class="tabbable-custom tabbable-tabdrop">
        <ul class="nav nav-tabs">
            ...
            {!! apply_filters(BASE_FILTER_REGISTER_CONTENT_TABS, null, new \ZHXCore\Language\Models\Language) !!}
        </ul>
        <div class="tab-content">
            <div class="tab-pane active" id="tab_detail">
                <div class="row">
                    <div class="col-md-5">
                        @php do_action(BASE_ACTION_META_BOXES, 'top', new \ZHXCore\Language\Models\Language) @endphp
                        <div class="main-form">
                            <div class="form-wrap">
                        ...
                        @php do_action(BASE_ACTION_META_BOXES, 'advanced', new \ZHXCore\Language\Models\Language) @endphp
                    </div>
                    <div class="col-md-7">
