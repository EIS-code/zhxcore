...
@section ('page')
    ...
    @include('core/base::layouts.partials.header-mobile')

    <div class="d-flex flex-column flex-root">
        <!--begin::Page-->
        <div class="d-flex flex-row flex-column-fluid page">

            @include('core/base::layouts.partials.aside')
            ...
            @include('core/base::layouts.partials.top-header')
                ...
                <!--begin::Content-->
                <div class="content {{ \ZHXCore\Base\Supports\Theme\Metronic::printClasses('content', false) }} d-flex flex-column flex-column-fluid" id="kt_content">
                ...
                {!! Breadcrumbs::render('main', page_title()->getTitle(false)) !!}
                    ...
                    <div class="d-flex flex-column-fluid">
                        <!--begin::Container-->
                        <div class="{{ \ZHXCore\Base\Supports\Theme\Metronic::printClasses('content-container', false) }}">
                            @yield('content')
                        </div>
                        <!--end::Container-->
                    </div>
