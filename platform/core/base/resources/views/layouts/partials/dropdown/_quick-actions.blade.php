...
@else
    <div class="d-flex flex-column flex-center py-10 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url('{{ asset('vendor/core/media/misc/bg-1.jpg') }}')">
...
<div class="row row-paddingless">
    ...
    <div class="col-6">
        <a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
            {{ \ZHXCore\Base\Supports\Theme\Metronic::getSVG("vendor/core/media/svg/icons/Shopping/Euro.svg", "svg-icon-3x svg-icon-success") }}
    ...
    <div class="col-6">
        <a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-bottom">
            {{ \ZHXCore\Base\Supports\Theme\Metronic::getSVG("vendor/core/media/svg/icons/Communication/Mail-attachment.svg", "svg-icon-3x svg-icon-success") }}
    ...
    <div class="col-6">
        <a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-right">
            {{ \ZHXCore\Base\Supports\Theme\Metronic::getSVG("vendor/core/media/svg/icons/Shopping/Box2.svg", "svg-icon-3x svg-icon-success") }}
    ...
    <div class="col-6">
        <a href="#" class="d-block py-10 px-5 text-center bg-hover-light">
            {{ \ZHXCore\Base\Supports\Theme\Metronic::getSVG("vendor/core/media/svg/icons/Communication/Group.svg", "svg-icon-3x svg-icon-success") }}
