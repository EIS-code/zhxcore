{{-- Header --}}
<div id="kt_header" class="header {{  \ZHXCore\Base\Supports\Theme\Metronic::printClasses('header', false) }}" {{  \ZHXCore\Base\Supports\Theme\Metronic::printAttrs('header') }}>

    {{-- Container --}}
    <div class="container-fluid d-flex align-items-center justify-content-between">
        @if (config('core.base.layout.header.self.display'))

            @php
                $kt_logo_image = 'logo_white.png';
            @endphp

            @if (config('core.base.layout.header.self.theme') === 'light')
                @php $kt_logo_image = 'logo-dark.png' @endphp
            @elseif (config('core.base.layout.header.self.theme') === 'dark')
                @php $kt_logo_image = 'logo-light.png' @endphp
            @endif

            {{-- Header Menu --}}
            <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                @if(config('core.base.layout.aside.self.display') == false)
                    <div class="header-logo">
                        <a href="{{ url('/') }}">
                            <img alt="Logo" src="{{ asset('vendor/core/media/logos/'.$kt_logo_image) }}"/>
                        </a>
                    </div>
                @endif

                <div id="kt_header_menu" class="header-menu header-menu-mobile {{  \ZHXCore\Base\Supports\Theme\Metronic::printClasses('header_menu', false) }}" {{  \ZHXCore\Base\Supports\Theme\Metronic::printAttrs('header_menu') }}>
                    <!--begin::Header Nav-->
                    <ul class="menu-nav {{  \ZHXCore\Base\Supports\Theme\Metronic::printClasses('header_menu_nav', false) }}">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        @endif
            ...
            <div class="topbar">
                ...
                {{-- Search --}}
                @if (config('core.base.layout.extras.search.display'))
                    @if (config('core.base.layout.extras.search.layout') == 'offcanvas')
                        <div class="topbar-item">
                            <div class="btn btn-icon btn-clean btn-lg mr-1" id="kt_quick_search_toggle">
                                {{ \ZHXCore\Base\Supports\Theme\Metronic::getSVG("vendor/core/media/svg/icons/General/Search.svg", "svg-icon-xl svg-icon-primary") }}
                            </div>
                        </div>
                    @else
                        <div class="dropdown" id="kt_quick_search_toggle">
                            ...
                            <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                                @include('core/base::layouts.partials.dropdown._search-dropdown')
                            </div>
                        </div>
                    @endif
                @endif
                ...
                {{-- Notifications --}}
                @if (config('core.base.layout.extras.notifications.display'))
                    @if (config('core.base.layout.extras.notifications.layout') == 'offcanvas')
                        <div class="topbar-item">
                            <div class="btn btn-icon btn-clean btn-lg mr-1 pulse pulse-primary" id="kt_quick_notifications_toggle">
                                {{ \ZHXCore\Base\Supports\Theme\Metronic::getSVG("vendor/core/media/svg/icons/Code/Compiling.svg", "svg-icon-xl svg-icon-primary") }}
                    ...
                    @else
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                                <form>
                                    @include('core/base::layouts.partials.dropdown._notifications')
                                </form>
                            </div>
                        </div>
                    @endif
                ...
                {{-- Quick Actions --}}
                @if (config('core.base.layout.extras.quick-actions.display'))
                    @if (config('core.base.layout.extras.quick-actions.layout') == 'offcanvas'))
                    <div class="topbar-item">
                        <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1" id="kt_quick_actions_toggle">
                            {{ \ZHXCore\Base\Supports\Theme\Metronic::getSVG("vendor/core/media/svg/icons/Media/Equalizer.svg", "svg-icon-xl svg-icon-primary") }}
                        </div>
                    </div>
                    @else
                        <div class="dropdown">
                            ...
                            {{-- Dropdown --}}
                            <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                                @include('core/base::layouts.partials.dropdown._quick-actions')
                            </div>
                        </div>
                    @endif
                @endif
                ...
                {{-- My Cart --}}
                @if (config('core.base.layout.extras.cart.display'))
                    <div class="dropdown">
                        {{-- Toggle --}}
                        <div class="topbar-item"  data-toggle="dropdown" data-offset="10px,0px">
                            <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                                {{ \ZHXCore\Base\Supports\Theme\Metronic::getSVG("vendor/core/media/svg/icons/Shopping/Cart3.svg", "svg-icon-xl svg-icon-primary") }}
                            </div>
                        </div>
                        ...
                        <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
                            <form>
                                @include('core/base::layouts.partials.dropdown._cart')
                            </form>
                        </div>
                    </div>
                @endif
                ...
                {{-- Quick panel --}}
                @if (config('core.base.layout.header.topbar.quick-panel.display'))
                    <div class="topbar-item">
                        <div class="btn btn-icon btn-clean btn-lg mr-1" id="kt_quick_panel_toggle">
                            {{ \ZHXCore\Base\Supports\Theme\Metronic::getSVG("vendor/core/media/svg/icons/Layout/Layout-4-blocks.svg", "svg-icon-xl svg-icon-primary") }}
                        </div>
                    </div>
                @endif

                {{-- Languages --}}
                @if (config('core.base.layout.extras.languages.display'))
                    <div class="dropdown">
                        <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                            <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                                <img class="h-20px w-20px rounded-sm" src="{{ asset('vendor/core/media/svg/flags/226-united-states.svg') }}" alt=""/>
                            </div>
                        </div>

                        <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                            @include('core/base::layouts.partials.dropdown._languages')
                        </div>
                    </div>
                @endif

                {{-- User --}}
                @if (config('core.base.layout.extras.user.display'))
                    @if (config('core.base.layout.extras.user.layout') == 'offcanvas')
                        <div class="topbar-item">
                            <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                                <span class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">Hi,</span>
                                <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"> {{ auth()->user()->getFullName() }}</span>
                                <span class="symbol symbol-35 symbol-light-success">
                                    <span class="symbol-label font-size-h5 font-weight-bold">{{ strlen(auth()->user()->getFullName()) > 0 ? substr(auth()->user()->getFullName(), 0, 1) : 'S' }}</span>
                                </span>
                            </div>
                        </div>
                    @else
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
                                @include('core/base::layouts.partials.dropdown._user')
                        </div>
                    @endif
                @endif
            </div>
