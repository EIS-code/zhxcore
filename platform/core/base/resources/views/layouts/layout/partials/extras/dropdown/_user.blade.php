@if (config('layout', 'extras/user/dropdown/style') == 'light')
    ...
    <div class="d-flex align-items-center p-8 rounded-top">
        ...
        <div class="symbol symbol-md bg-light-primary mr-3 flex-shrink-0">
            <img src="{{ asset('vendor/core/media/users/300_21.jpg') }}" alt=""/>
        </div>
...
@else
    {{-- Header --}}
    <div class="d-flex align-items-center justify-content-between flex-wrap p-8 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url('{{ asset('vendor/core/media/misc/bg-1.jpg') }}')">
