...
use ZHXCore\Base\Exceptions\Handler;
use ZHXCore\Base\Http\Middleware\DisableInDemoModeMiddleware;
use ZHXCore\Base\Http\Middleware\HttpsProtocolMiddleware;
use ZHXCore\Base\Http\Middleware\LocaleMiddleware;
use ZHXCore\Base\Models\MetaBox as MetaBoxModel;
use ZHXCore\Base\Repositories\Caches\MetaBoxCacheDecorator;
use ZHXCore\Base\Repositories\Eloquent\MetaBoxRepository;
use ZHXCore\Base\Repositories\Interfaces\MetaBoxInterface;
use ZHXCore\Base\Supports\CustomResourceRegistrar;
use ZHXCore\Base\Supports\Helper;
use ZHXCore\Base\Supports\Theme\Init;
use ZHXCore\Base\Traits\LoadAndPublishDataTrait;
use ZHXCore\Setting\Providers\SettingServiceProvider;
...
class BaseServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $config->set([
            ...
            'session.cookie'                   => 'zhxcore_session',
    ...
    {
        $this->setNamespace('core/base')
            ->loadAndPublishConfigurations(['permissions', 'assets', 'layout'])
            ->loadAndPublishViews()
