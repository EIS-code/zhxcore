...
class Metronic
{
    ...
    {
        if (config('core.base.layout.resources.fonts.google.families')) {
            $fonts = config('core.base.layout.resources.fonts.google.families');
    ...
    public static function initThemes()
    {
        ...
        $themes[] = 'css/themes/layout/header/base/'.config('core.base.layout.header.self.theme').'.css';
        $themes[] = 'css/themes/layout/header/menu/'.config('core.base.layout.header.menu.desktop.submenu.theme').'.css';
        $themes[] = 'css/themes/layout/aside/'.config('core.base.layout.aside.self.theme').'.css';

        if (config('core.base.layout.aside.self.display')) {
            $themes[] = 'css/themes/layout/brand/'.config('core.base.layout.brand.self.theme').'.css';
        } else {
            $themes[] = 'css/themes/layout/brand/'.config('core.base.layout.header.self.theme').'.css';
        }
