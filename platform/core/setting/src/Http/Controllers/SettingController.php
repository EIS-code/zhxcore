...
namespace ZHXCore\Setting\Http\Controllers;

use Assets;
use ZHXCore\Base\Supports\Core;
use ZHXCore\Setting\Http\Requests\EmailTemplateRequest;
use ZHXCore\Setting\Http\Requests\LicenseSettingRequest;
use ZHXCore\Setting\Http\Requests\MediaSettingRequest;
use ZHXCore\Setting\Http\Requests\SendTestEmailRequest;
...
class SettingController extends BaseController
{
    ...
    public function getVerifyLicense(Core $coreApi, BaseHttpResponse $response)
    {
        $data = [
            ...
            'licensed_to'  => 'ZHXSCRIPT LLC',
        ];

        return $response->setMessage('Success')->setData($data);
