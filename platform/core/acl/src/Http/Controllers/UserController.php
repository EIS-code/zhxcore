...
namespace ZHXCore\ACL\Http\Controllers;

use Assets;
use ZHXCore\Media\Services\ThumbnailService;
use File;
use Illuminate\Contracts\View\Factory;
use Illuminate\Http\RedirectResponse;
use Illuminate\Support\Facades\Auth;
use ZHXCore\ACL\Forms\PasswordForm;
use ZHXCore\ACL\Forms\ProfileForm;
use ZHXCore\ACL\Forms\UserForm;
use ZHXCore\ACL\Tables\UserTable;
use ZHXCore\ACL\Http\Requests\CreateUserRequest;
use ZHXCore\ACL\Http\Requests\UpdatePasswordRequest;
use ZHXCore\ACL\Http\Requests\UpdateProfileRequest;
use ZHXCore\ACL\Models\UserMeta;
use ZHXCore\ACL\Repositories\Interfaces\RoleInterface;
use ZHXCore\ACL\Repositories\Interfaces\UserInterface;
use ZHXCore\ACL\Services\ChangePasswordService;
use ZHXCore\ACL\Services\CreateUserService;
...
use ZHXCore\ACL\Http\Requests\AvatarRequest;
use Exception;
