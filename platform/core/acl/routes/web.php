...
use ZHXCore\ACL\Http\Controllers\Auth\ForgotPasswordController;
use ZHXCore\ACL\Http\Controllers\Auth\LoginController;
use ZHXCore\ACL\Http\Controllers\Auth\ResetPasswordController;
use ZHXCore\ACL\Http\Controllers\UserController;

Route::group(['namespace' => 'ZHXCore\ACL\Http\Controllers', 'middleware' => 'web'], function () {
