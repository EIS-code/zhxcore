...
{{-- Styles Section --}}
@section('styles')
    <link href="{{ asset('vendor/core/plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('scripts')
    {{-- vendors --}}
    <script src="{{ asset('vendor/core/plugins/custom/datatables/datatables.bundle.js') }}" type="text/javascript"></script>

    {{-- page scripts --}}
    <script src="{{ asset('vendor/core/js/pages/crud/datatables/basic/basic.js') }}" type="text/javascript"></script>
    <script src="{{ asset('vendor/core/js/app.js') }}" type="text/javascript"></script>
    <script src="{{ asset('vendor/core/js/table.js') }}" type="text/javascript"></script>
    <script src="{{ asset('vendor/core/js/filter.js') }}" type="text/javascript"></script>
@endsection
