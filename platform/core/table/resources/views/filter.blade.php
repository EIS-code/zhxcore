    ...
    <div class="sample-filter-item-wrap hidden">
        <div class="filter-item form-filter">
            <div class="ui-select-wrapper">
                <select class="form-control filter-column-key" id="kt_select2_1" name="filter_columns[]">
            ...
            <div class="ui-select-wrapper">
                <select name="filter_operators[]" class="form-control ui-select filter-operator filter-column-operator">
    ...
    <div class="filter_list inline-block filter-items-wrap">
        @foreach($requestFilters as $filter_key => $filter_item)
            <div class="filter-item form-filter @if ($loop->first) filter-item-default @endif">
                <div class="ui-select-wrapper">
                    <select name="filter_columns[]" class="form-control ui-select filter-column-key">
                        <option value="">{{ trans('core/table::general.select_field') }}</option>
                        @foreach($columns as $column_key => $column)
                ...
                <div class="ui-select-wrapper">
                    <select name="filter_operators[]" class="form-control ui-select filter-column-operator">
                        <option value="like"
