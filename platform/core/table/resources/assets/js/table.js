(($, DataTable) => {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: dt => {
            return '<i class="fas fa-file-excel"></i> ' + dt.i18n('buttons.excel', ZHXCoreVariables.languages.tables.excel);
        },
    ...
    DataTable.ext.buttons.export = {
        ...
        text: dt => {
            return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.export', ZHXCoreVariables.languages.tables.export) + '&nbsp;<span class="caret"/>';
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: dt => {
            return '<i class="fas fa-file-excel"></i> ' + dt.i18n('buttons.csv', ZHXCoreVariables.languages.tables.csv);
        },
    ...
    DataTable.ext.buttons.print = {
        ...
        text: dt => {
            return '<i class="fa fa-print"></i> ' + dt.i18n('buttons.print', ZHXCoreVariables.languages.tables.print);
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: dt => {
            return '<i class="fa fa-undo"></i> ' + dt.i18n('buttons.reset', ZHXCoreVariables.languages.tables.reset);
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: dt => {
            return '<i class="fas fa-sync"></i> ' + dt.i18n('buttons.reload', ZHXCoreVariables.languages.tables.reload);
        },
    ...
    class TableManagement {
        ...
        handleActionsRow() {
            ...
            $(document).on('click', '.delete-many-entry-trigger', event => {
                ...
                if (ids.length === 0) {
                    ZHXCore.showError('Please select at least one record to perform this action!');
                    return false;
                }
