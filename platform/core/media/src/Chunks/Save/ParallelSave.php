...
namespace ZHXCore\Media\Chunks\Save;

use Illuminate\Http\UploadedFile;
use Illuminate\Support\Str;
use ZHXCore\Media\Chunks\ChunkFile;
use ZHXCore\Media\Chunks\Exceptions\MissingChunkFilesException;
use ZHXCore\Media\Chunks\FileMerger;
use ZHXCore\Media\Chunks\Handler\AbstractHandler;
...
class ParallelSave extends ChunkSave
{
    ...
    /**
     * {@inheritDoc}
     * @throws \ZHXCore\Media\Chunks\Exceptions\ChunkSaveException
