...
namespace ZHXCore\Media;

use ZHXCore\Media\Http\Resources\FileResource;
...
use ZHXCore\Media\Services\UploadsManager;
...
class RvMedia
{
    ...
    /**
     * @param \ZHXCore\Media\Models\MediaFile|\Illuminate\Database\Eloquent\Model $file
     * @return bool
     */
